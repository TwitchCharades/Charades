  ...
  private createSplashWindow(): void {
	...
	private async createMainWindow(): Promise<void> {
		...
		this.mainWindow.webContents.on(APP_EVENTS.DID_FINISH_LOAD, () => {
			this.mainWindow?.webContents.send(APP_EVENTS.MAIN_PROCESS_MESSAGE, (new Date).toLocaleString());
		});
	...
	private setupIpcHandlers(): void {
		...
		ipcMain.on(IPC_EVENTS.WINDOW_ACTION, (_event, action: 'minimize' | 'maximize' | 'close') => {
